...
const DATA = {
    ...
    contact: {
        social: {
            GitHub: {
                name: "GitHub",
                url: "https://github.com/eletroswing",
                icon: Icons.github,
            },
            LinkedIn: {
                name: "LinkedIn",
                url: "https://www.linkedin.com/in/ytalo-da-silva-66000423a/",
                icon: Icons.linkedin,
            },
            X: {
                name: "X",
            ...
            email: {
                name: "Send Email",
                url: "mailto:contato@fountai.dev",
                icon: Icons.email,
            },
        },
    },
...
export function DockComponent(props?: Omit<DockProps, 'children'>) {
    ...
    const ensureNavigation = (href: string) => {
